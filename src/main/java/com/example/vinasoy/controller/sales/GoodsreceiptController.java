...
public class GoodsreceiptController {
    ...
    public ResponseEntity<?> findAllCustomer(
        ...
        PageResponse<?> goodReceiptPageResponse = goodsreceiptService.findAllPaginationWithSortByMultipleColumns(pageSize, pageNo, sortBy);
        ApiResponse<PageResponse<?>> apiResponse = new ApiResponse<>();
        apiResponse.setData(goodReceiptPageResponse);
        return ResponseEntity.status(HttpStatus.OK).body(apiResponse);
    }
}
